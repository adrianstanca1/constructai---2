                                ...
                                displayedRfis.map(rfi => {
                                    ...
                                    return (
                                        <li 
                                            ...
                                            className={`p-4 flex items-center justify-between hover:bg-gray-50 cursor-pointer ${overdue ? 'bg-red-100' : ''}`}
                                        >
                                            ...
                                            <div className="text-right flex flex-col items-end gap-1">
                                                <span className={`px-4 py-2 text-base font-bold rounded-lg ${getStatusColor(rfi.status)}`}>
                                                    {rfi.status}
                                                </span>
